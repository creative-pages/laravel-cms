        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ url('/home') }}" class="site_title"><i class="fa fa-paw"></i> <span>Gentelella Alela!</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{ asset('admin-theme') }}/images/img.jpg" alt="..." class="img-circle profile_img">
              </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li>
                    <a href="{{ url('/page/company') }}">
                      <i class="fa fa-columns"></i>Company
                    </a>
                  </li>
                  <li>
                    <a href="{{ url('/page/service') }}">
                      <i class="fa fa-columns"></i>service
                    </a>
                  </li>
                  <li>
                    <a href="{{ url('/page/contact') }}">
                      <i class="fa fa-columns"></i>Contact
                    </a>
                  </li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('admin-theme') }}/images/img.jpg" alt="">John Doe
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="{{ asset('admin-theme') }}/images/img.jpg" alt="Profile Image" /></span>
                        <span>
